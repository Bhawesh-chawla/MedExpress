...
function AdminPanel(props) {
  ...
  const BloodSubmitHandler = () => {
    fetch(
      "http://localhost:8084/blood/update/" + bloodGroup + "/" + bloodCount,
      { method: "PUT" }
    );
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8086/appointment/getAllAppointments")
      .then((res) => {
        ...
        <div className="col-md-4">
          <span style={{ marginRight: "5px" }}>
            <button
              ...
              onClick={() => {
                axios
                  .delete("http://localhost:8086/appointment/deleteAll")
